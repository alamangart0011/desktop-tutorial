const DOCS = [
  ...
  {
    cat: 'КоАП',
    title: 'Ст. 13.11 КоАП РФ (ред. ФЗ № 420 от 30.11.2024)',
    text: 'Нарушение законодательства в области ПДн. Стандартные нарушения по ч. 1–6 — до 700 тыс. ₽; утечка ПДн по ч. 13–15 — от 3 до 15 млн ₽; повторно (ч. 16) — оборотный штраф 1–3 % выручки.',
    href: 'https://www.consultant.ru/document/cons_doc_LAW_34661/',
  },
  {
    cat: 'КоАП',
    title: 'ФЗ № 420-ФЗ от 30.11.2024',
    text: 'Закон, ужесточивший ст. 13.11 КоАП. Ввёл повышенные штрафы за утечку ПДн и оборотный штраф за повторное нарушение. Действует с 30.05.2025.',
    href: 'http://publication.pravo.gov.ru/document/0001202411300062',
  },
  {
    cat: 'Реестры',
      ...
      <div className="container-x">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-3xl md:text-4xl font-extrabold tracking-tight">
            Девять ключевых документов для подключения к ГИС
          </h2>
