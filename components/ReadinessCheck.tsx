  ...
  const verdict = useMemo(() => {
    if (score <= 3)
      return {
        ...
        text:
          'Инфраструктура и документы не готовы. Подключение к ГИС «Профилактика» под угрозой, а штрафы по ст. 13.11 КоАП за утечку ПДн — до 15 млн ₽ юр. лицу (ред. ФЗ № 420 от 30.11.2024). Нужен аудит и внедрение под ключ.',
