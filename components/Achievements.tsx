...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    suffix: ' АРМ',
    label: 'защищено СЗИ',
    note: 'Суммарно за 12 лет — Secret Net Studio, ПАК «Соболь», КриптоПро',
  },
  {
    target: 100,
    suffix: '%',
    label: 'приёмок с первой попытки',
    note: 'Все аттестационные испытания пройдены без возвратов на доработку',
  },
];
