...
const PAINS: Pain[] = [
  ...
  },
  {
    Icon: RubleIcon,
    t: 'Штрафы до 5 млн ₽',
    d: 'За несоответствие требованиям по ПДн несовершеннолетних по 13.11 КоАП: до 200 тыс. ₽ должностным лицам, до 5 млн ₽ юр. лицам.',
    solve: 'Закрываем все пункты 21 Приказа ФСТЭК — штраф исключён',
  },
  {
    Icon: FileTextIcon,
