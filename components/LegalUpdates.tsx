const EVENTS = [
  ...
  },
  {
    ...
    text: 'Новые меры по мониторингу, управлению уязвимостями и реагированию на инциденты. Вступил в силу с 01.03.2026.',
  },
  {
    date: '01.12.2025',
    tag: 'Полный запуск',
  ...
  {
    date: '01.03.2026',
    tag: 'ФСТЭК 117 → боевой режим',
    title: 'Новые требования применяются',
    text: 'Все ИСПДн, включая ГИС «Профилактика», обязаны соответствовать 117 Приказу. Штрафы по 13.11 КоАП применяются без отсрочек.',
  },
  {
    date: 'Сегодня',
    tag: '13.11 КоАП',
