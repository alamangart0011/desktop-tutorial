const EVENTS = [
  ...
  },
  {
    date: 'Апрель 2026',
    tag: '13.11 КоАП',
    title: 'Штрафы за утечку ПДн в полную силу',
    text: 'ФЗ № 420-ФЗ от 30.11.2024 ввёл новые штрафы по ч. 13–15 ст. 13.11 КоАП: 3–15 млн ₽ юр. лицу за утечку ПДн. Региональные прокуратуры активно проводят проверки подключения к ГИС «Профилактика».',
  },
];
