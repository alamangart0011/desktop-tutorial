...
const REVISION_DATE = '18 апреля 2026 г.';
    ...
    <main className="bg-white text-[var(--color-ink)]">
      <div className="container-x py-12 md:py-16 max-w-3xl">
        ...
        <div className="prose prose-slate mt-8 max-w-none text-[15px] leading-relaxed space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                ...
                {BRAND.rknRegistryNumber
                  ? `№ ${BRAND.rknRegistryNumber}`
                  : 'уведомление подано, ожидается внесение в реестр'}
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold mt-8">6. Сроки обработки и хранения</h2>
            <p>
              Персональные данные, полученные через формы на сайте, обрабатываются в течение
              периода выполнения целей обработки, но не более 3 (трёх) лет с момента последнего
              обращения. По запросу субъекта данные удаляются в течение 10 рабочих дней, если их
              сохранение не требуется по закону (в частности, по ст. 23 152-ФЗ, ст. 29 НК РФ —
              налоговая тайна, ст. 17 402-ФЗ — бухгалтерская отчётность по договорам).
            </p>
            <p>
              Журнал заявок с IP-адресами и техническими метаданными хранится 12 месяцев для целей
              аудита информационной безопасности и противодействия мошенничеству, после чего
              безвозвратно удаляется.
            </p>
          </section>
